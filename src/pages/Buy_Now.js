...
export default class Buy_Now extends Component<{}>{
    ...
    placeOrder(){
        ...
        checkOutData.coupon_code = this.state.applied_coupon;
                ...
                .then((response)=>{
                    ...
                    if (response.code == '200') {
                        ...
                        /*const resetAction = NavigationActions.reset({
                            index: 1,
                            actions: [
                                this.props.navigation.navigate('details',{slug:this.state.slug,img:this.state.product_image,id:this.state.product_id,vendor_id:this.state.vendor_id}),
    ...
    componentWillMount(){
        ...
        this.setState({
            ...
            slug : params.slug,
            spec : params.spec,
            emptyScreen : params.screen ? params.screen : false
        });
        this.setState({
                ...
                fetch(url,{
                    ...
                    .then((response)=>{
                        ...
                        if (response.code == '200') {
                            if (response.data) {
                                this.setState({
                                    applied_coupon : Data.coupon_code,
                            ...
                            <View style = {{width:'100%',alignItems:'center',justifyContent:'center',marginTop:10}}>
                                <View style = {{width:'97%',flexDirection:'row',backgroundColor:'#fff',elevation:2,alignItems:'center',justifyContent:'center'}}>
                                    <TextInput style = {styles.input1}
                                               placeholderTextColor="#336600"
                                               placeholder='Your coupon'
                                               onChangeText = {(c_code) => this.setState({coupon : c_code})}
