...
export default class Menu extends Component<{}> {
  ...
  _renderRow = (rowItem, rowId, sectionId) => (
    <Text
      style={{ fontSize: 14, marginLeft: 20, marginTop: 10 }}
      onPress={() =>
        this.props.navigation.navigate('shop', { name: rowItem.name })}
    >
      {rowItem.name}
    </Text>
  );
  _renderSection = (section, sectionId) => (
    <Text
      style={{ marginLeft: 10, marginTop: 20, fontSize: 16, color: '#363a42' }}
    >
      {section}
    </Text>
  );
          ...
          <View>
            <View>
              ...
              >
                ...
                <Text
                  style={{ fontSize: 16, color: '#363a42', marginLeft: 10 }}
