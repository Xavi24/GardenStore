...
export default class Login extends Component<{}> {
  ...
  navigateToLogin () {
    ...
    /* const resetAction = StackActions.reset({
             index: 1,
             actions: [
                 NavigationActions.navigate({ routeName: this.state.page }),
                 NavigationActions.navigate({ routeName: this.state.next })
             ]
         });

         this.screenprop.navigation.dispatch(resetAction);*/
  }
  reg () {
    this.textInput.clear ();
    this.textInput2.clear ();
            ...
            >
              <View style={styles.content_view}>
                ...
                <View style={{width: '90%', marginBottom: 10}}>
                  <Text style={{color: '#c7011a', marginLeft: 10}}>
                    {this.state.err_msg}
                  </Text>
                </View>
                <TouchableHighlight
